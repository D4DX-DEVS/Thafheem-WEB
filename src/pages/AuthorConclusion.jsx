    ...
    <div className="p-6 dark:bg-gray-900 min-h-screen">
      <div className="sm:max-w-[1070px] max-w-[350px] w-full mx-auto font-poppins">
        {isMalayalam ? (
          ...
          <h2 className={`text-2xl font-bold mb-4 dark:text-white border-b border-gray-300 dark:border-gray-600 pb-2 ${isUrdu ? 'font-urdu' : isBangla ? 'font-bengali' : isHindi ? 'font-hindi' : ''}`} dir={dir}>
            {title}
          </h2>
        )}
          ...
          <>
            <style>{`
              .hindi-conclusion-content {
                ...
                font-family: 'NotoSansDevanagari', 'Poppins', sans-serif !important;
              }
              .hindi-conclusion-content h1,
              .hindi-conclusion-content h2,
              .hindi-conclusion-content h3,
              .hindi-conclusion-content h4 {
            ...
            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 sm:p-8 md:p-10 lg:p-12">
              <div
                className="hindi-conclusion-content prose max-w-none prose-sm sm:prose-base dark:prose-invert text-gray-800 dark:text-gray-100 font-hindi"
