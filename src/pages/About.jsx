...
const About = () => {
  ...
  return (
    <div className=" mx-auto min-h-screen p-6 bg-white dark:bg-gray-900 font-poppins">
      ...
      {isMalayalam && (
        <style>{`
          .malayalam-about-content,
          .malayalam-about-content * {
            font-family: 'Noto Sans Malayalam', serif !important;
          }
          .malayalam-about-content p {
          ...
          .malayalam-about-content p:last-child {
      ...
      <div className="max-w-[1070px] w-full mx-auto">
        ...
        <div className={`dark:text-white text-gray-800 leading-relaxed ${fontClass}`} dir={dir}>
          {isUrdu ? (() => {
            ...
            <div className="bg-white dark:bg-[#1b1d27] rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-5 sm:p-7 malayalam-about-content">
              <div
