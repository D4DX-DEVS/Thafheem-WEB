...
const SurahInfo = () => {
  ...
  const shouldShowUrduIntroOnly =
    translationLanguage === "ur" && urduIntroSections.length > 0;
  ...
  const shouldShowTamilIntroOnly =
    translationLanguage === "ta" && tamilIntroSections.length > 0;
      ...
      <div className="w-full max-w-[1290px] mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6">
        ...
        <div className="font-poppins">
          ...
          {shouldShowMalayalamPrefaceOnly && (
            <div className="mb-6 sm:mb-8">
              {translationLanguage === "mal" && (
                <style>
                  {`
                    .surah-preface-content, .surah-preface-content * {
              ...
              <div
                className="text-gray-700 leading-relaxed dark:text-white text-sm sm:text-base lg:text-lg px-1 sm:px-0 space-y-4 surah-preface-content font-malayalam"
                style={translationLanguage === 'mal' ? { fontFamily: "'Noto Sans Malayalam', sans-serif", lineHeight: '2' } : {}}
          ...
          {shouldShowUrduIntroOnly && (
            <div className="mb-6 sm:mb-8">
              {surahInfo?.urduIntroAudioUrl ? (
                <div className="mb-4">
                  <audio
                    controls
                    preload="none"
                    src={surahInfo.urduIntroAudioUrl}
                    className="w-full"
                  />
                </div>
              ) : null}
              <div
                className="text-gray-700 dark:text-white px-1 sm:px-0 space-y-4 urdu-surah-intro"
              >
          ...
          {shouldShowBanglaIntroOnly && (
            <div className="mb-6 sm:mb-8">
              ...
              `}</style>
              <div className="font-bengali text-justify text-gray-700 dark:text-white px-1 sm:px-0 text-sm sm:text-base lg:text-lg space-y-4 bangla-surah-intro leading-relaxed">
                {banglaIntroSections.map((section, index) => {
                  ...
                  return (
                    <div key={index} className="space-y-3">
                      {section.subtitle ? (
                        <h4 className="text-base sm:text-lg lg:text-xl font-semibold text-cyan-500 font-bengali">
                          {section.subtitle}
                        </h4>
                      ) : null}
                      {cleanedText ? (
                      ...
                      {index === banglaIntroSections.length - 1 && section.source ? (
                        <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 italic mt-2">{section.source}</p>
                      ) : null}
                    </div>
                  );
                })}
          ...
          {shouldShowTamilIntroOnly && (
            <div className="mb-6 sm:mb-8">
              <div className="text-gray-700 dark:text-white px-1 sm:px-0 text-sm sm:text-base lg:text-lg space-y-4 tamil-surah-intro font-tamil">
          ...
          {!shouldShowMalayalamPrefaceOnly && !shouldShowUrduIntroOnly && !shouldShowBanglaIntroOnly && translationLanguage !== "ta" && surahInfo?.detailed?.short_text && (
            <div className="mb-6 sm:mb-8">
          ...
          {!shouldShowMalayalamPrefaceOnly && !shouldShowUrduIntroOnly && !shouldShowBanglaIntroOnly && translationLanguage !== "ta" && surahInfo?.detailed?.text && (
            <div className="mb-6 sm:mb-8">
              ...
              {translationLanguage === 'hi' ? (
                <div
                  className="text-gray-700 leading-relaxed dark:text-white text-sm sm:text-base lg:text-lg px-1 sm:px-0 hindi-surah-intro font-hindi"
          ...
          {/* Thafheem Commentary - Properly parsed sections (hidden for Malayalam/Urdu/Tamil/Bangla to avoid duplication) */}
          {!shouldShowMalayalamPrefaceOnly && !shouldShowUrduIntroOnly && !shouldShowBanglaIntroOnly && translationLanguage !== "ta" && parsedThafheemSections.length > 0 && (
            <div className="mb-6 sm:mb-8">
              <h3 className="text-lg sm:text-xl lg:text-2xl font-semibold text-cyan-600 mb-3 sm:mb-4">
                Thafheem Commentary
              </h3>
          ...
          {!surahInfo?.detailed?.text && parsedThafheemSections.length === 0 && !shouldShowMalayalamPrefaceOnly && !shouldShowUrduIntroOnly && !shouldShowBanglaIntroOnly && translationLanguage !== "ta" && (
            <div className="mb-6 sm:mb-8">
              <h3 className="text-lg sm:text-xl lg:text-2xl font-semibold text-cyan-600 mb-3 sm:mb-4">
                Basic Information
              </h3>
