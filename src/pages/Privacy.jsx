          ...
          <div className="prose prose-base dark:prose-invert max-w-none text-justify">
            ...
            <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
              ...
              <p className="text-base text-[#2AA0BF] mb-2">
                Tel: <a href="tel:+919895804006" className="text-[#2AA0BF] hover:underline dark:text-[#4FAEC7]">+91 98958 04006</a>
              </p>
              <p className="text-base text-[#2AA0BF] mb-2">
                E-mail: <a href="mailto:info@d4dx.co" className="text-[#2AA0BF] hover:underline dark:text-[#4FAEC7]">info@d4dx.co</a>, <a href="mailto:mail@d4dx.co" className="text-[#2AA0BF] hover:underline dark:text-[#4FAEC7]">mail@d4dx.co</a>
              </p>
