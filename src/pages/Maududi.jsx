        ...
        return (
            <>
                <style>{`
                    ...
                    .hindi-maududi-content h1,
                    .hindi-maududi-content h2,
                    ...
                    .hindi-maududi-content ul,
                    .hindi-maududi-content ol {
                        text-align: left !important;
                ...
                <div className="mx-auto bg-white dark:bg-gray-900 p-2 sm:p-4 md:p-6 lg:p-8 font-poppins">
                    <div className="max-w-[959.01px] mx-auto px-2 sm:px-4 lg:px-4">
                        <div className="mb-4 sm:mb-6 md:mb-8 border-b border-gray-300 dark:border-gray-600 pb-2">
                            <h1 className="text-lg sm:text-xl md:text-2xl font-bold text-black dark:text-white font-hindi text-center">
                        ...
                        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 sm:p-8 md:p-10 lg:p-12">
                            <div
                                className="hindi-maududi-content prose max-w-none prose-sm sm:prose-base dark:prose-invert text-gray-800 dark:text-gray-100 font-hindi"
                                style={{
