...
const UrduJesusMohammed = () => {
  ...
  return (
    <div className="p-6 dark:bg-gray-900 min-h-screen" dir="rtl">
      <style>{`
        .urdu-jesus-mohammed-content {
          direction: rtl;
        }
        .urdu-jesus-mohammed-content p,
        .urdu-jesus-mohammed-content h1,
        .urdu-jesus-mohammed-content h2,
        .urdu-jesus-mohammed-content h3,
        .urdu-jesus-mohammed-content h4,
        .urdu-jesus-mohammed-content li,
        .urdu-jesus-mohammed-content strong,
        .urdu-jesus-mohammed-content b {
          direction: rtl;
      ...
      <div className="sm:max-w-[1070px] max-w-[350px] w-full mx-auto font-poppins">
        <h2
          className="text-2xl font-bold mb-2 dark:text-white border-b border-gray-300 dark:border-gray-600 pb-2 text-right"
          dir="rtl"
          ...
          <div className="space-y-8" dir="rtl">
            {sections.map((section, index) => (
              ...
              >
                {section.title && (
                  <div
                    className="urdu-section-title mb-4 text-gray-900 dark:text-white"
