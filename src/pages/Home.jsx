...
import FloatingUserGuideButton from "../components/FloatingUserGuideButton";
    ...
    <>
      ...
      <div className="w-full mx-auto bg-white dark:bg-gray-900 min-h-screen">
        <div className="max-w-[1290px] w-full mx-auto px-5 sm:px-6 md:px-8 lg:px-10 xl:px-12">
          ...
          {/* Floating User Guide button — pinned to the viewport corner, above the cards grid */}
          {translationLanguage === "mal" && <FloatingUserGuideButton />}
