...
const MalayalamInterpreter = () => {
  ...
  return (
    ...
    <InterpretationNavbar 
      ...
      onWordByWord={() => {}} 
    />
      <div className="w-full  mx-auto p-3 sm:p-4 lg:p-6 bg-white dark:bg-[#1C1C1E] max-w-[1073px] ">
        <div className="space-y-4 sm:space-y-6">
          ...
          {content.map((item, idx) => (
            <div
              key={idx}
              className="bg-gray-50 dark:bg-[#1C1C1E] p-3 sm:p-4 lg:p-6 rounded-lg border-l-4 dark:border-[#1C1C1E] border-white"
            >
              <div
...
<div className=" bottom-0 left-0 w-full flex justify-between gap-3 sm:gap-0 p-3 sm:p-4 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-[#1C1C1E] z-50">
  <button
