...
const IntroductionToQuran = () => {
  ...
  useEffect(() => {
    if ((!isHindi && !isMalayalam) || loading || sections.length === 0) return;
    ...
    sections.forEach((section, index) => {
      const el = document.getElementById(`introduction-section-${index}`);
      if (!el) return;
  ...
  }, [isHindi, isMalayalam, loading, sections]);

  useEffect(() => {
    if ((!isHindi && !isMalayalam) || !sidebarNavRef.current) return;
  ...
  }, [isHindi, isMalayalam, activeSection]);
  ...
  return (
    <div className="p-6 dark:bg-gray-900 min-h-screen">
      ...
      {isMalayalam && (
        <style>{`
          .malayalam-introduction-content,
          .malayalam-introduction-content * {
            font-family: 'Noto Sans Malayalam', serif !important;
          }
          .malayalam-introduction-content p,
          .malayalam-introduction-content li,
          .malayalam-introduction-content div:not(.malayalam-introduction-content) {
            text-align: justify !important;
            text-justify: inter-word !important;
          ...
          .malayalam-introduction-content h1,
          .malayalam-introduction-content h2,
          .malayalam-introduction-content h3,
          .malayalam-introduction-content h4,
          .malayalam-introduction-content strong {
            font-family: 'Noto Sans Malayalam', serif !important;
            margin-bottom: 0.8em !important;
          }
          .malayalam-introduction-content p:last-child,
          .malayalam-introduction-content li:last-child,
          .malayalam-introduction-content div:not(.malayalam-introduction-content):last-child {
                    ...
                    <div className="flex-1 min-w-0 max-w-[900px] mx-auto space-y-8">
                      {sections.map((section, index) => (
                        ...
                        >
                          {section.title && (
                            <div
                              className="mb-4 prose prose-lg dark:prose-invert max-w-none font-hindi"
                              dangerouslySetInnerHTML={{ __html: section.title }}
                            />
                          )}
                          <div
                            className="prose prose-sm sm:prose-base dark:prose-invert max-w-none leading-relaxed text-gray-800 dark:text-gray-200 font-hindi"
                            dangerouslySetInnerHTML={{ __html: section.text || '' }}
                            style={{
                              lineHeight: 1.8,
                              textAlign: 'justify',
                ...
                <div className="space-y-8">
                  {sections.map((section, index) => (
                    ...
                    >
                      {section.title && (
                        <div
                          className={`mb-4 prose prose-lg dark:prose-invert max-w-none ${isHindi ? 'font-hindi' : isBangla ? 'font-bengali' : isTamil ? 'font-tamil tamil-introduction-content' : ''}`}
                          dangerouslySetInnerHTML={{ __html: section.title }}
                          style={isTamil ? { fontFamily: "'Bamini', serif", textAlign: 'justify' } : {}}
                        />
                      )}
                      <div
                        className={`prose prose-sm sm:prose-base dark:prose-invert max-w-none leading-relaxed text-gray-800 dark:text-gray-200 ${isHindi ? 'font-hindi' : isBangla ? 'font-bengali' : isTamil ? 'tamil-introduction-content' : ''}`}
                        dangerouslySetInnerHTML={{ __html: section.text || '' }}
                        style={isTamil ? {
                          lineHeight: 1.8,
                          textAlign: 'justify',
