              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                {currentJuz.surahs.map((surah, index) => (
                  <div
                    ...
                    className="bg-white dark:bg-[#252525] rounded-xl shadow-sm border border-gray-200 dark:border-gray-600 p-4 sm:p-6 cursor-pointer transition-all duration-200 hover:shadow-md hover:border-cyan-500 dark:hover:border-cyan-400"
                  >
                    {/* Surah Card */}
              ...
              {[0, 1, 2].map((columnIndex) => (
                <div key={columnIndex} className="w-full">
                  {getColumnData(columnIndex).map((juz) => (
                    <div
                      key={juz.id}
                      className="bg-[#EBEEF0] dark:bg-[#252525] rounded-xl shadow-sm border-gray-100 overflow-hidden m-2 sm:m-4 w-full max-w-[400px] mx-auto lg:mx-0"
                    >
                      {/* Header */}
                      <div className="bg-[#EBEEF0] dark:bg-[#252525] dark:text-white px-3 sm:px-4 py-1 flex justify-between items-center">
                          ...
                          >
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <div className="text-right flex-shrink-0 ml-2">
                                ...
                                >
                                  {surahNameUnicodes[surah.number] && surah.number !== 111
                                    ? String.fromCharCode(
                                        parseInt(
