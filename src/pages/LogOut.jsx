          ...
          <div className="bg-white dark:bg-[#1C1C1E] rounded-lg shadow-xl p-6 w-96 max-w-md mx-4">
            ...
            <div className="flex justify-end gap-3">
              <button
                ...
                className="px-4 py-2 text-gray-700 border dark:text-white dark:hover:bg-[#1C1C1E] border-gray-300 rounded hover:bg-gray-50 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Cancel
              </button>
              <button
