...
const VideoPlayer = () => {
    ...
    <div className="w-[350px] sm:w-full max-w-[933px] mx-auto bg-[#D9D9D9] rounded-lg overflow-hidden shadow-lg">
      ...
      <div className="bg-[#D9D9D9] p-3 dark:bg-[#434343]">
        ...
        <div className="mb-3">
          <div
            ref={progressRef}
            className="w-full sm:h-[3px] h-[3px] bg-white dark:bg-[#252525] rounded-full cursor-pointer relative touch-manipulation"
  ...
  <img src={BackwardIcon} alt="Forward" className="sm:w-5 w-[16px] sm:h-5 h-[16px]" />
            ...
            <button
              ...
              className="p-3 bg-white dark:bg-[#1C1C1E] rounded-full shadow-sm"
            >
              {isPlaying ? (
