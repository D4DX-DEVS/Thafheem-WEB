...
//   return (
//     <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-[#1C1C1E] shadow-lg z-50">
//       <audio
//         ref={audioRef}
//         src={audioSrc}
//         preload="metadata"
...
//             {/* Dropdown Menu */}
//             {showMenu && (
//               <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 bg-white dark:bg-[#1C1C1E] border border-gray-200 dark:border-gray-600 rounded-lg shadow-lg py-2 min-w-40">
...
//                       setShowMenu(false);
//                     }}
//                     className="w-full px-4 py-2 text-left text-sm text-gray-700 dark:text-white hover:bg-gray-100 dark:hover:bg-[#141414] transition-colors"
//                   >
//                     {option.label}
//                   </button>
//                 ))}
...
//               className="p-2 text-gray-600 bg-[#D9D9D9] hover:text-gray-800 transition-colors rounded-full hover:bg-gray-100 dark:text-white dark:bg-[#141414]"
//             >
...
//             {showVolumeSlider && (
//               <div 
//                 className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 bg-white dark:bg-[#1C1C1E] border border-gray-200 dark:border-gray-600 rounded-lg shadow-lg p-3"
...
//   className="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-[#141414] flex items-center justify-center"
// >
//   <img
//     src={BackwardIcon}
//     alt="Forward"
...
//             className="p-2 lg:p-3 bg-gray-100 dark:bg-[#141414] text-black dark:text-white rounded-full transition-colors hover:bg-gray-200 dark:hover:bg-[#0F1117]"
//           >
...
//           <button
//             onClick={onClose}
//             className="p-2 text-black hover:text-gray-800 transition-colors rounded-full hover:bg-gray-100 dark:text-white dark:hover:bg-[#141414]"
//           >
//             <X size={18} />
//           </button>
//         </div>
...
const QuranStudyPlay = ({ audioSrc, title, onClose, autoPlay = false, isMobile = false }) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-[#1C1C1E] border-t border-gray-200 shadow-lg z-50 h-[90px]">
      <audio
        ref={audioRef}
        src={audioSrc}
        preload="metadata"
