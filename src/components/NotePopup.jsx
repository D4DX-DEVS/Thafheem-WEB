  ...
  return createPortal(
    <>
      ...
      <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-[99999] px-4 animate-backdrop-fade-in">
        <div className={`bg-white dark:bg-[#1C1C1E] rounded-xl shadow-2xl w-full sm:w-auto ${containerWidthClass} max-w-[95vw] max-h-[90vh] flex flex-col overflow-hidden transition-all duration-200 animate-modal-slide-up border border-gray-200 dark:border-gray-700`}>
