            ...
            <div className="flex items-center space-x-2 flex-1">
              <div className="relative inline-block" ref={surahBtnRef}>
                <button
                  ...
                  className="flex items-center space-x-2 rounded-full px-4 py-2 bg-[#EBEEF0] dark:bg-[#252525] text-black dark:text-white transition-colors"
                >
            ...
            <div className="flex items-center space-x-4">
              <div className="relative inline-block" ref={surahBtnRef}>
                <button
                  ...
                  className="flex items-center space-x-2 rounded-full px-4 py-2 bg-[#EBEEF0] dark:bg-[#252525] text-black dark:text-white hover:text-gray-900 dark:hover:text-white transition-colors"
                >
