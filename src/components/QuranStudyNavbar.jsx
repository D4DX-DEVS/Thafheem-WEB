...
const QuranStudyNavbar = ({ activeItem, setActiveItem }) => {
  ...
  if (loading) {
    return (
      <div className="lg:hidden bg-white dark:bg-[#1C1C1E] border-b border-gray-200 shadow-sm">
        <div className="p-4">
  ...
  return (
    <>
        ...
        <div className="p-4">
          ...
          <div className="relative">
            <button
              ...
              className="w-full flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-[#141414] border border-gray-200 dark:border-gray-600 rounded-lg text-left text-black dark:text-white"
            >
            ...
            {isDropdownOpen && (
              <div className="absolute top-full left-0 right-0 mt-1 bg-white dark:bg-[#1C1C1E] border border-gray-200 dark:border-gray-600 rounded-lg shadow-lg z-50 max-h-64 overflow-y-auto">
                {navigationItems.map((item, index) => (
                  <button
                    key={index}
                    onClick={() => handleItemClick(item)}
                    className={`w-full text-left px-4 py-3 text-sm transition-all duration-200 hover:bg-gray-50 dark:hover:bg-[#141414] ${
      ...
      {/* Desktop Sidebar */}
      <div className="hidden lg:block w-[332px] bg-white border-r border-gray-200 shadow-lg h-screen overflow-y-auto dark:bg-[#1C1C1E] m-4">
        {/* Header */}
        <div className="bg-white dark:text-white text-black p-4 dark:bg-[#1C1C1E] shadow-md">
