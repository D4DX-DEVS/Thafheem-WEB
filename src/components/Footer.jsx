...
const Footer = () => {
  ...
  const quickLinks = [
    ...
    ...(translationLanguage === 'mal' ? [{ label: 'User Guide', path: '/user-guide' }] : []),
  ...
  return (
    <footer className="relative bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-black py-6 md:py-8 mt-auto font-poppins border-t border-gray-200 dark:border-gray-800">
      ...
      <div className="max-w-[1290px] mx-auto px-4 sm:px-6 lg:px-8">
        {/* Main Footer Content */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-8 mb-4 md:mb-6">
          {/* Brand Section */}
          ...
          <div className="flex flex-col items-center md:items-start space-y-2 md:space-y-3">
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
              ...
              >
                <Mail className="w-4 h-4" />
                <span>info@d4dx.co</span>
              </a>
            </div>
            <div className="flex flex-row gap-2 md:gap-3 w-full justify-center md:justify-start">
              <a
                href="https://play.google.com/store/apps/details?id=com.d4media.thafheem"
                target="_blank"
                rel="noopener noreferrer"
