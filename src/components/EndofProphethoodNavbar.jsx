...
setActiveSection(data[0]);
  ...
  return (
    <>
      {/* Mobile Dropdown */}
      <div className="lg:hidden bg-white dark:bg-[#1C1C1E] border-b border-gray-200 sticky top-0 z-40">
        <div className="p-4">
      ...
      {/* Desktop Sidebar */}
      <div className="hidden lg:block w-80 bg-white border-r border-gray-200 shadow-lg h-screen overflow-y-auto dark:bg-[#1C1C1E] m-4">
